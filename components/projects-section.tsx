...
const projects = [
  ...
  },
  {
    ...
    description: "A blockchain RPG (Play-to-Earn) built on the Avalanche network.",
    image: "/port24.png",
    tags: ["React", "Next.js", "Solidity", "Web3.js"],
    category: "blockchain",
    github: "https://github.com/stack-weaver/The-Legend-of-Aurum-Draconis",
    demo: "https://aurumdraconis.dragoncrypto.io/",
    longDescription:
      "The Legend of Aurum Draconis is a fantasy role-playing game (RPG) by Dragon Crypto Gaming",
    features: ["Solidity", "Avalanche", "NFT"],
  },
  {
    id: 25,
    title: "Pulsar – Web3 MMO RTS on Avalanche",
    description: "Pulsar – Web3 MMO RTS on Avalanche",
    image: "/port25.png",
    tags: ["React", "Next.js", "Solidity", "Rust", "Web3.js"],
    category: "blockchain",
    github: "https://github.com/stack-weaver/Pulsar-a-free-to-play-MMO-RTS-blockchain-game-on-the-Avalanche-subnet",
    demo: "https://pulsar.game/",
    longDescription:
      "Pulsar is a next-generation free-to-play MMO real-time strategy game built on the Avalanche subnet.",
    features: ["Solidity", "Avalanche", "Rust", "Javascript"],
  },
  {
    id: 26,
    title: "Recent Weather Modern Web Application",
    description: "A responsive web weather application built with modern front-end technology",
    image: "/port26.png",
    tags: ["Java", "Next.js", "Tailwindcss"],
    category: "fullstack",
    github: "https://github.com/stack-weaver/Lucent-Weather-Modern-Web-Weather-Application",
    demo: "https://lucent-weather.netlify.app/",
    longDescription:
      "A responsive web weather application built with modern front-end technologies",
    features: ["Typescript", "Java", "Next.js"],
  },
  {
    id: 27,
    title: "Automation Builder",
    description: "Fuzora is a powerful SaaS automation builder",
    image: "/port27.png",
    tags: ["React", "Next.js", "Tailwindcss", "Prisma"],
    category: "ai",
    github: "https://github.com/stack-weaver/Automation-Builder",
    demo: "https://www.fuzora.xyz/",
    longDescription:
      "Fuzora is a powerful SaaS automation builder that helps you streamline your workflow by connecting your favorite tools and automating tasks with ease.",
    features: ["React-flow", "Stripe", "Prisma", "Uploadcare"],
  },
  {
    id: 28,
    title: "A Solana-powered decentralized trading protocol.",
    description: "Drift Protocol is a decentralized exchange built on Solana.",
    image: "/port28.png",
    tags: ["React", "Next.js", "Tailwindcss", "Web3.js", "Solidity"],
    category: "blockchain",
    github: "https://github.com/stack-weaver/A-Solana-powered-decentralized-trading-protocol.",
    demo: "https://app.drift.trade/",
    longDescription:
      "Drift Protocol is a decentralized exchange built on Solana.",
    features: ["dAPP", "Ethereum", "Smart contract", "Trading", "Typescript"],
  },
  {
    id: 29,
    title: "AI-Powered Prediction Market Analytics",
    description: "Predly.ai is an AI-powered prediction market analytics platform.",
    image: "/port29.png",
    tags: ["Next.js", "Python", "Tailwindcss", "Other"],
    category: "ai",
    github: "https://github.com/stack-weaver/Prediction-Market-Analytics",
    demo: "https://predly.ai/app",
    longDescription:
      "Spot profitable opportunities on Polymarket & Kalshi with real-time AI analysis.",
    features: ["AI", "Trading", "Prediction Markets", "Analytics"],
  },
  {
    id: 30,
    title: "Hamster Betting DApp",
    description: "A decentralized betting application built on blockchain technology",
    image: "/port30.png",
    tags: ["React", "Solidity", "ether.js", "Other"],
    category: "blockchain",
    github: "https://github.com/stack-weaver/A-Crypto-betting-dapp-for-hamsters",
    demo: "https://hamster-betting-d-app.vercel.app/",
    longDescription:
      "A decentralized betting application built on blockchain technology that allows users to place bets, view odds, and manage wagers securely with crypto wallet integration.",
    features: ["dAPP", "Ethereum", "Polygon", "Smart contract", "Walletconnect"],
  },
  {
    id: 31,
    title: "Solana DeFi Tokenomics Launchpad",
    description: "Users create tokens with built-in revenue-sharing capabilities.",
    image: "/port31.png",
    tags: ["React", "Next.js", "Rust", "Anchor", "Web.js"],
    category: "blockchain",
    github: "https://github.com/stack-weaver/Solana-DeFi-Tokenomics-Launchpad",
    demo: "https://revshare.dev/",
    longDescription:
      "Using Token-2022 standard, RevShare tokens automatically collect transfer fees from every transaction and distribute them proportionally to all token holders",
    features: ["TypeScript", "Solana", "DeFi", "Launchpad"],
  },
]
